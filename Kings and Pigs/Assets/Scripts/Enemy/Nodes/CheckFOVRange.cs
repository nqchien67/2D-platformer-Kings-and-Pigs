...
namespace Enemy
{
    public class CheckFOVRange : EnemyNode
    {
        ...
        {
            pointA.Set(enemy.ActiveArea[0].x - data.fovRange, enemy.ActiveArea[0].y + 0.8f * data.fovRange);
            pointB.Set(enemy.ActiveArea[1].x + data.fovRange, enemy.ActiveArea[1].y - 0.8f * data.fovRange);
        }
